export default {
    ...
    complaince:'合规性管理',
    unconventional_RDS:'不合规的RDS列表',
    unconventional_elb:'不合规的elb列表',
    unconventional_NatGateWay:'不合规NatGateWay列表',
    unconventional_iam:'未使用iam列表',
    unconventional_EIP: '未使用EIP列表',
    security_group:'未关联安全组',
    unconventional_ASG:'最小和所需都为0的ASG',
    notenabled_S3:'未启用s3',
    unconventional_vpcpeering:'不合规的vpcpeering',
    unconventional_EC2:'不合规的ec2信息列表'
}