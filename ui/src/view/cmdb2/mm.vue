    ...
    <Row :gutter="20">
      ...
      <div class="search-con search-con-top">
        <Input
            ...
            <Button type="success" class="search-btn" @click="handlerAssetUpdate">手动刷新</Button>
      </div>
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          align: "center",
          render: (h, params) => {
            let saftety = params.row.safety;
            if (saftety === true) {
              return h("div", [
                // <Checkbox label="PHP56"></Checkbox>
                h("Checkbox", { props: { value: true}, on: {} }, '全选')
              ]);
            } else {
              return h("div", [
                h("Tag", { props: { value: false}, on: {} }, "")
              ]);
            }
          } 
        },
