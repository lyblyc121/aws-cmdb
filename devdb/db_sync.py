...
from models.elb import Base as ELBINSBase
from models.elasticsearch import ElasticSearch as ESBase
...
def create():
    ...
    ELBINSBase.metadata.create_all(engine)
    ESBase.metadata.create_all(engine)
