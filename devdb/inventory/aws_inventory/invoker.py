...
from inventory.aws_inventory import store, config, progress
            ...
            try:
                ...
                if not params['dry_run']:
                    ...
                    if params['client'].can_paginate(py_op):
                        ...
                        if response[list(response.keys())[0]] and list(response.keys())[0] != 'ResponseMetadata':
                            if 'ResponseMetadata' in list(response.keys()):
